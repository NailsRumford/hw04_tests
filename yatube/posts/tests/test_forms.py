...
class PostCreateFormTest (TestCase):
    ...
    def test_create_post (self):
        ...
        expected_redirect_path = reverse('posts:profile', kwargs= {'username':str(self.user)})
...
class PostEditFormTest(TestCase):
    ...
    def test_post_edit (self):          
        ...
        expected_redirect_path = reverse('posts:post_detail', kwargs= {'post_id':self.post.id})
        form_data = {
            'text': self.post.text,
            'group': self.group.id,
        } 
